...
class ChatController extends GetxController {
  ...
  Future<String> createOrGetRoom({required String userId, required String providerId}) =>
      _repo.createOrGetRoom(userId: userId, providerId: providerId);

  void bindMessages(String roomId, {int limit = 100}) {
    _msgsSub?.cancel();
    _msgsSub = _repo.watchMessages(roomId, limit: limit).listen(messages.assignAll);
  }
