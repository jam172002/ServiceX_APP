...
import '../data/repos/job_repository.dart';
...
class JobController extends GetxController {
  ...
  void bindProviderJobs(String providerId) {
    _providerSub?.cancel();
    _providerSub = _repo.watchProviderJobs(providerId).listen(providerJobs.assignAll);
  }
  ...
  Future<void> markCompleted(String jobId) => _repo.updateStatus(jobId, JobStatus.completed);

  Future<void> markInProgress(String jobId) => _repo.updateStatus(jobId, JobStatus.inProgress);

  Future<void> assignProvider(String jobId, String providerId) => _repo.assignProvider(jobId, providerId);
}
