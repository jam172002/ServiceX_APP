...
class NotificationRepository {
  ...
  Stream<List<AppNotificationModel>> watchUserNotifications(String userId, {int limit = 200}) {
    return _col
  ...
  Future<void> markAsRead(String notificationId) async {
    await _col.doc(notificationId).set({'isRead': true}, SetOptions(merge: true));
  }
