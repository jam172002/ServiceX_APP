...
class ProviderController extends GetxController {
  ...
  void bindProfile(String providerId) {
    _sub?.cancel();
    _sub = _repo
        .watchProviderProfile(providerId)
        .listen((p) => profile.value = p);
  }
  ...
  Future<void> upsertProfile(ProviderProfileModel p) =>
      _repo.upsertProviderProfile(p);

  Future<void> setAvailability(String providerId, bool isAvailable) =>
      _repo.setAvailability(providerId, isAvailable);
}
